...
function openDealModal() {
    if(typeof toast === 'function') toast('Info', 'Skapa aff�r-funktionen kommer snart', 'info');
}
...
/* HOTFIX */
window.openAddCustomerModal = function() { console.log('OPENING CUSTOMER MODAL'); const modal = document.getElementById('crmAddCustomerModal'); if(modal) { modal.style.display = 'flex'; if(window.setModalTab && modal.querySelector('#modalTabBasic')) { const btn = modal.querySelector('.tabBtn'); if(btn) window.setModalTab('modalTabBasic', btn); } } else { alert('Kunde inte �ppna formul�r (ID saknas)'); } };
